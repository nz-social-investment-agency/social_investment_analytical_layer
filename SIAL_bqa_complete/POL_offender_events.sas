...
INPUT: 
[&idi_refresh.].[pol_clean].[pre_count_offenders]

OUTPUT: 
[&schema.].SIAL_POL_offender_events
...
create view [&schema.].SIAL_POL_offender_events
as select  snz_uid, /* This is the incident occurance ID */
		...
		from [&idi_refresh.].[pol_clean].[pre_count_offenders]
	...
	execute(select top 10 * from [&schema.].SIAL_POL_offender_events) by odbc;
